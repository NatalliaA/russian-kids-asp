<%@ Page Title="List Of Cartoons" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ListOfCartoons.aspx.vb" Inherits="RussianForKidsVB.ListOfCartoons" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9" style="background-color: #fcca70; border-style: solid; border-color: orange; border-radius: 20px; margin-right: 30px; margin-left: 30px; margin-bottom: 10px; padding: 20px">
                ...
                <asp:Label ID="Label2" runat="server" Font-Size="30px" Text="Cartoons"></asp:Label>
                <h4>Do you like watching cartoons? Here you can find many interesting cartoons to watch and learn Russian.</h4>

                <asp:ListView ID="ListView_Cartoons" runat="server" DataKeyNames="ID" DataSourceID="SqlDataSource1" GroupItemCount="3">
                    <AlternatingItemTemplate>
                        <td runat="server" style="font-size: 18px; font-family: Calibri; font-weight: normal; padding: 20px">
                            <asp:HyperLink ID="Song" runat="server" Text=' <%# Eval("Title") %>'
                                NavigateUrl='<%# Eval("ID", "~/Cartoon.aspx?ID={0}")%>' Font-Size="20px" ForeColor="Green" Font-Bold="True" />
                            <br />
                            <%# Eval("EnglishTitle") %>
                            <asp:HyperLink ID="Hyperlink1" NavigateUrl='<%# Eval("ID", "~/Cartoon.aspx?ID={0}") %>' runat="server" Font-Underline="false">
                            <img class="img-responsive img-responsive" style="max-width:220px; width:100%" src='<%# Eval("Picture") %>' alt="Picture"/>
                            </asp:HyperLink>
                        </td>
                    </AlternatingItemTemplate>
                    <EditItemTemplate>
                    ...
                    <ItemTemplate>
                        <td runat="server" style="font-size: 18px; font-family: Calibri; font-weight: normal; padding: 20px">
                            ...
                            <%# Eval("EnglishTitle") %>
                            <asp:HyperLink ID="Hyperlink1" NavigateUrl='<%# Eval("ID", "~/Cartoon.aspx?ID={0}") %>' runat="server" Font-Underline="false">
                            <img class="img-responsive img-rounded" style="max-width:220px; width:100%" src='<%# Eval("Picture") %>' alt="Picture"/>
                            </asp:HyperLink>
                        </td>
                    </ItemTemplate>
                    <LayoutTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LearnRussianConnectionString %>" ProviderName="<%$ ConnectionStrings:LearnRussianConnectionString.ProviderName %>" SelectCommand="SELECT [ID], [Title], [EnglishTitle], [VideoLink], [Picture] FROM [ListOfCartoons]"></asp:SqlDataSource>
