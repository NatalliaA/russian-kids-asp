...
Public Class Song
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim SqlString As String = "SELECT VideoLink FROM ListOfSongs WHERE ID=" + Request.QueryString("ID")
            ...
            Dim NumberLikesSql As String = "SELECT Count(*) FROM LikesSong WHERE song_fkid=@f2"
            ...
            If Request.IsAuthenticated Then
                ...
                Dim doesLikeSql As String = "SELECT * FROM LikesSong WHERE Song_fkid=@f4 AND Reader=@f5"
            ...
            Dim CommentsSqlString As String = "SELECT * FROM CommentsSong WHERE Song_fkid=@f1"
            ...
            Dim NumberCommentsSql As String = "SELECT Count(*) From CommentsSong WHERE Song_fkid=@f3"
    ...
    Protected Sub btn_like_Click(sender As Object, e As EventArgs) Handles btn_like.Click
        If Request.IsAuthenticated Then
            Dim oleDbConn As New OleDb.OleDbConnection(ConfigurationManager.ConnectionStrings("LearnRussianConnectionString").ConnectionString)
            oleDbConn.Open()
            Dim likeSql As String = "INSERT INTO LikesSong(Song_fkid,Reader) Values (@f1,@f2)"
            ...
            Dim NumLikesSql As String = "SELECT Count(*) FROM LikesSong WHERE Song_fkid=@f2"
    ...
    Protected Sub btn_addComment_Click(sender As Object, e As EventArgs) Handles btn_addComment.Click
        If Request.IsAuthenticated Then
            ...
            Dim oleDbConn As New OleDb.OleDbConnection(ConfigurationManager.ConnectionStrings("LearnRussianConnectionString").ConnectionString)
            Dim SqlString As String = "INSERT INTO CommentsSong (WriterName,Comment, Song_fkid, DayPosted) Values (@f1,@f3,@f4, @f5)"
            Dim cmd As OleDbCommand = New OleDbCommand(SqlString, oleDbConn)
            ...
            Dim fillComments As String = "SELECT * FROM CommentsSong WHERE Song_fkid=@f1"
            ...
            Dim NumberCommSql As String = "SELECT Count(*) From CommentsSong WHERE Song_fkid=@f3"
