<%@ Page Title="List Of Songs" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ListOfSongs.aspx.vb" Inherits="RussianForKidsVB.ListOfSongs" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9" style="background-color: #fcca70; border-style: solid; border-color: orange; border-radius: 20px; margin-right: 30px; margin-left: 30px; margin-bottom: 10px; padding: 20px">
                ...
                <asp:Label ID="Label2" runat="server" Font-Size="30px" Text="Songs"></asp:Label>
                <h4>Do you like songs? Singing songs is a great way to get better at speaking Russian. Have fun!</h4>
                    ...
                    <AlternatingItemTemplate>
                        <td runat="server" style="font-size: 18px; font-family: Calibri; font-weight: normal; padding: 20px">
                            <asp:HyperLink ID="Song" runat="server" Text=' <%# Eval("Title") %>'
                                NavigateUrl='<%# Eval("ID", "~/Song.aspx?ID={0}")%>' Font-Size="20px" ForeColor="Green" Font-Bold="True" />
                            <br />
                            <%# Eval("EnglishTitle") %>
                            <asp:HyperLink ID="Hyperlink1" NavigateUrl='<%# Eval("ID", "~/Song.aspx?ID={0}")%>' runat="server" Font-Underline="false">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LearnRussianConnectionString %>" ProviderName="<%$ ConnectionStrings:LearnRussianConnectionString.ProviderName %>" SelectCommand="SELECT [ID], [Title], [EnglishTitle], [VideoLink], [Lyrics], [Picture] FROM [ListOfSongs]"></asp:SqlDataSource>
            </div>
