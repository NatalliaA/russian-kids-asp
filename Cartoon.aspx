<%@ Page Title="Cartoon" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Cartoon.aspx.vb" Inherits="RussianForKidsVB.Cartoon" %>
            ...
            <div class="col-md-9" style="background-color: #fcca70; border-style: solid; border-color: orange; border-radius: 20px; margin-right: 30px; margin-left: 30px; margin-bottom: 10px">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8" style="margin-top: 10px">
                            ...
                            <div class="col-md-12" style="background-color: oldlace; border-radius: 20px; border-color: plum; border-style: solid; padding: 20px; margin-bottom: 10px;">
                                ...
                                <asp:Label ID="Label9" runat="server" Text="Watch the Cartoon" Font-Bold="true" Font-Size="18px" ForeColor="BlueViolet"></asp:Label>
                                <br />
                                <br />
                    ...
                    <asp:Label ID="PictureLabel" runat="server" Text='<%# Eval("Picture") %>' />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LearnRussianConnectionString %>" ProviderName="<%$ ConnectionStrings:LearnRussianConnectionString.ProviderName %>" SelectCommand="SELECT [ID], [Title], [EnglishTitle], [VideoLink], [Picture] FROM [ListOfCartoons] WHERE ([ID] = ?)">
                                    <SelectParameters>
                            ...
                            <div class="col-md-12" style="background-color: #cae4f7; border-style: solid; border-color: #42acfa; border-radius: 20px; padding: 20px; margin-bottom: 10px">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:LearnRussianConnectionString %>" ProviderName="<%$ ConnectionStrings:LearnRussianConnectionString.ProviderName %>" SelectCommand="SELECT [ID], [Cartoon_fkid], [WriterName], [Title], [Comment], [DayPosted] FROM [CommentsCartoon] WHERE ([Cartoon_fkid] = ?)">
                                            <SelectParameters>
                                                <asp:QueryStringParameter Name="Cartoon_fkid" QueryStringField="ID" Type="Int32" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
    ...
    <asp:Button ID="btn_addComment" runat="server" OnClick="btn_addComment_Click" Text="Add Comment"
        CssClass="btn btn-success pull-right" BackColor="#ffff00" ForeColor="Brown" Font-Bold="true" Font-Size="16px" Height="35px" Width="150px" />
                        ...
                        <div class="col-md-4" style="background-color: #d9ff79; border-style: solid; border-color: #8fbf14; border-radius: 20px; padding: 20px; margin-top: 10px; margin-bottom: 10px;">
                            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                <ContentTemplate>
                                    ...
                                    <br />
                                    <br />
                                    <asp:ListView ID="ListView_Task" runat="server" DataKeyNames="ID" DataSourceID="SqlDataSource3" GroupItemCount="3">
                                        <AlternatingItemTemplate>
                        ...
                        <asp:Label ID="TaskCommentLabel" runat="server" Text='<%# Eval("TaskComment") %>' />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:LearnRussianConnectionString %>" ProviderName="<%$ ConnectionStrings:LearnRussianConnectionString.ProviderName %>" SelectCommand="SELECT [ID], [TaskMultipleChoice], [TaskTranslate], [TaskComment] FROM [ListOfCartoons] WHERE ([ID] = ?)">
                                        <SelectParameters>
                                            <asp:QueryStringParameter Name="ID" QueryStringField="ID" Type="Int32" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                        ...
                        <asp:Label ID="AnswerTranslateLabel" runat="server" Text='<%# Eval("AnswerTranslate") %>' />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:LearnRussianConnectionString %>" ProviderName="<%$ ConnectionStrings:LearnRussianConnectionString.ProviderName %>" SelectCommand="SELECT [ID], [AnswerMultiple], [AnswerTranslate] FROM [ListOfCartoons] WHERE ([ID] = ?)">
                                        <SelectParameters>
                                            <asp:QueryStringParameter Name="ID" QueryStringField="ID" Type="Int32" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
