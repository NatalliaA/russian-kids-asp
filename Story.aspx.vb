...
Public Class Story
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Dim CommentsSqlString As String = "SELECT * FROM CommentsStory WHERE Story_fkid=@f1"
            ...
            Dim NumberCommentsSql As String = "SELECT Count(*) From CommentsStory WHERE Story_fkid=@f3"
            ...
            Dim NumberLikesSql As String = "SELECT Count(*) FROM LikesStory WHERE Story_fkid=@f2"
            ...
            If Request.IsAuthenticated Then
                ...
                Dim doesLikeSql As String = "SELECT * FROM LikesStory WHERE Story_fkid=@f4 AND Reader=@f5"
    ...
    Protected Sub btn_like_Click(sender As Object, e As EventArgs) Handles btn_like.Click
        If Request.IsAuthenticated Then
            Dim oleDbConn As New OleDb.OleDbConnection(ConfigurationManager.ConnectionStrings("LearnRussianConnectionString").ConnectionString)
            oleDbConn.Open()
            Dim likeSql As String = "INSERT INTO LikesStory(Story_fkid,Reader) Values (@f1,@f2)"
            ...
            Dim NumLikesSql As String = "SELECT Count(*) FROM LikesStory WHERE Story_fkid=@f2"
    ...
    Protected Sub btn_addComment_Click(sender As Object, e As EventArgs) Handles btn_addComment.Click
        If Request.IsAuthenticated Then
            ...
            Dim oleDbConn As New OleDb.OleDbConnection(ConfigurationManager.ConnectionStrings("LearnRussianConnectionString").ConnectionString)
            Dim SqlString As String = "INSERT INTO CommentsStory(WriterName, Comment, Story_fkid, DayPosted) Values (@f1,@f3,@f4, @f5)"
            ...
            Dim fillComments As String = "SELECT * FROM CommentsStory WHERE Story_fkid=@f1"
            ...
            Dim NumberCommSql As String = "SELECT Count(*) From CommentsStory WHERE Story_fkid=@f3"
